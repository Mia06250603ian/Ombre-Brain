...
**颜色**:纸片配色 2026-09-01 换过一轮 —— 第一版是黄+蓝,所有者一句「好丑」,已撤销。
现用的那版见 `dashboard.html` 的 `.todo-note` 一节。**别再自作主张调色**:
手册里那条教训(1.8 之前那轮 dwell UI 留下的)是「颜色别靠截图猜,做几版给她看真实效果、或者给滑杆让她自己调」。
