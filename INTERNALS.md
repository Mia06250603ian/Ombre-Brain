...
| **底光** | **浅色:纯灰 5% / 3.8%,三团** / **深色:纯灰 1%,两团**(没动) | ⚠️⚠️ **2026-09-03 当天来回改了三轮,定稿是这版,别照任何一版旧文改回去**:①原「1%、纯灰」(她 08-31 拿滑杆定的)—— **太淡,玻璃没东西可透,白盖白**;②改成「蓝 13% + 紫 10%」的彩光 —— 她说「**我并不想要这么高的饱和度**」;③一度整个撤成近乎没有(去追 iOS 平面)—— 她说「**我就是想要玻璃质感啊你改改没了**」。**定稿的想法:玻璃要的是「背后有东西可透」,不等于「背后必须有颜色」** —— **纯灰的深浅变化一样能透出层次**。所以现在是**零饱和的中性灰**,但**强度回到看得见**(远高于原来的 1%)。⚠️ **别加颜色**(她明确不要),**也别调回 1%**(那等于没有玻璃)。**三团**:只有两个角有光的话,往下滚就滚出去了 |
