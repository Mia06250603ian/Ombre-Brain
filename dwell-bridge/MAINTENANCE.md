...
## 手感校准:2026-09-10 所有者定的五个数(**未合、未部署、未真机确认**)
...
**停在哪**:`Mia06250603ian/dwell-on-something` **PR #3**(分支 `claude/ui-feel-calibration`)。
**合之前要所有者在真机上过一眼** —— 手册那条「预览不等于实机」照旧算数。
**上线**还要照本手册第 5 节跑 `fetch-frontend.sh` + 部署,**Zeabur 那一步要所有者本人点**。
