...
**这份清单是 2026-08-02 那次重建留下的,2026-08-21 第二次、2026-09-01 第三次完整跑过、五步全过**(桶数 356→356、MCP 3/3 200、容器 `server.py` md5 与仓库逐字一致、日志三类报错各 0)。三次的完整实况分别见 `TIMELINE.md` 的 08-02、08-21、09-01。
