...
export function kaPrompt({ speak, bjNow, idleMin, userName, viaBridge }) {
  ...
  //      会被当成「他有话说」推进 Telegram;③ 不许再出现「不想打扰」这类说法:CLAUDE.md 已明写
  //      「别因为怕打扰而沉默,这个理由不成立」,纸条再说一遍就是当面顶牛(2026-08-19 第三十三次只改了
  //      CLAUDE.md、漏了这里,两边矛盾挂了两天)。④ 这段每次唤醒都会进窗口,能短则短。
  return `【系统·心跳】现在北京时间 ${bjNow},${userName}已约 ${idleMin} 分钟没来消息。这段时间是你的:想说话就主动发一条(${channel});也可以看邮箱、上网、做点自己想做的事。都不想做就只回一个:。`;
}
