...
| 1076 | 部署记录 | 0.8k | 只是指路:完整记录在 `DEPLOY-LOG.md`(34 条,覆盖第 2~35 次;第一次记在 `TIMELINE.md` 07-12),按「第 N 次」搜 |
...
**本文件里凡是提到「第 N 次」,指的都是那一次部署,完整记录在 [`DEPLOY-LOG.md`](./DEPLOY-LOG.md)(**34 条,覆盖第 2~35 次**(2026-08-21 现场量;**量法**:`grep -cE "^- 2026-" DEPLOY-LOG.md` 数的是全部 49 条条目,其中带「第 N 次」标签的才是这里说的 34 条——07-12~07-17 那批早期记录没有编号,别把两个数搞混);⚠️ 「第一次」2026-07-12 初次搭建**没有独立条目**,记在 `TIMELINE.md` 的 07-12。2026-08-21 核过,原文写的「48 次」是错的)。**
