...
| 799 | ~~待办~~ 「她在干嘛」改写 | 0.4k | 历史,已上线,一般不用读 |
| 817 | 她在干嘛(如果开了) | 0.5k | 动查岗功能时读 |
| 833 | ~~待办~~ 表情包补螃蟹 | 0.8k | 历史,已上线 |
| 856 | 表情包(如果接了 Telegram) | 0.8k | 动贴纸时读 |
| 879 | ~~待办~~ 「待办便利贴」 | 1.0k | 历史,已上线 |
| 904 | ~~待办~~ 「记错了 / 过期了」 | 3.9k | 历史,已上线(2026-08-19 第三十四次) |
| 999 | 建议(未做) | 1.5k | 想找「还能改什么」时读 |
| 1047 | **2026-08-21 心跳「自主活动」+ 压缩点实测** | 1.2k | **改心跳文案 / 动上下文阈值前读**。心跳纸条的**四条机械约束**在这节(`【。】` 判不出沉默那条是硬伤);压缩点**实测 166942**,并撤销了「改人设要跟着下调阈值」的旧推算 |
| 1080 | 2026-08-10 第三十一次的机制细节 | 0.2k | 下面四小节的引子 |
| 1087 | └ ① 161500 硬线永久静音 | 0.6k | 动上下文守卫阈值前读 |
| 1108 | └ ② 终线原话桶顺序错乱 | 0.2k | 〃 |
| 1119 | └ ③ 压缩摘要压不住九节 | 2.6k | 〃 **⚠️ 结论已更新(2026-08-24)**:纸条早已上线,第一次真压缩**成功**(九节命中 0、纸条那句命中 1)——**但晏没照做,压缩后没 awaken**。所有者说不修。问「为什么压缩后他不 awaken」先读这节 |
| 1190 | └ ④ awaken 的全文位把日记桶挤掉了 | 0.6k | ⚠️ **这节讲的是 OB,不是 shim** —— 改 OB 的 `awaken` 之前必读。**现在的结论是「OB 不用改」**;它里面那个「必然重演、要按类型各保一条」的旧结论**已被所有者当场推翻并撤销,别照它改**。另外它留了一把量「awaken 会不会把开机撑爆」的尺子(2026-08-10:占 27%;2026-08-21 钉选改出全文后:28%),往 awaken 加东西前拿它量一遍 |
| 1210 | 部署记录 | 0.8k | 只是指路:完整记录在 `DEPLOY-LOG.md`(**36 条,覆盖第 2~37 次**,2026-08-24 现场量;第一次记在 `TIMELINE.md` 07-12),按「第 N 次」搜 |
